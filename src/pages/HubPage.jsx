      ...
      <div className="relative z-10 w-full max-w-3xl px-6 py-12">
        <div className="grid grid-cols-2 gap-4">
          ...
          <a 
            ...
            className="group relative rounded-2xl bg-black border border-white border-opacity-10 flex items-center justify-center p-8 transition-all duration-500 hover:border-opacity-40 hover:shadow-2xl hover:shadow-white/30 hover:scale-105"
